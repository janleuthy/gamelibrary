...
<div class="row justify-content-center topmargin">
    <form class="col-6">
        ...
        <div class="form-group">
            ...
            <input id="username" name="username" type="text" class="form-control" placeholder="Benutzername" value="<?= $user->username; ?>" required oninput="checkInputUserName(this)">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input id="password" name="password" type="password" class="form-control" placeholder="Neues Passwort" value="" required oninput="checkInputPassword(this)">
        </div>
        <div class="form-group">
            <label class="control-label" for="password2">Neues Passwort bestätigen</label>
            <input id="password2" name="password2" type="password" class="form-control" placeholder="Neues Passwort bestätigen" value="" required oninput="checkInputPasswordRepeat(this)">
        </div>
